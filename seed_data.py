...
def seed_data():
    ...
    ms_switches = [
        ...
        MSSwitch(model="C switch9300-24P-M", use_case="secure wi-fi 6/7", ports_1gbe=24, ports_mgig=0, uplinks="4x 1G/10G SFP/SFP+", poe_support="PoE+", stackable=True, routing="dynamic", catalyst=True),
